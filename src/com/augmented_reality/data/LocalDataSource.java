...
public class LocalDataSource extends DataSource {
    ...
    public List<Marker> getMarkers() {
    	String vic=null;
        Marker atl = new IconMarker("ATL ICON", 39.931268, -75.051262, 0, Color.DKGRAY, icon,vic,null);
        cachedMarkers.add(atl);

        Marker home = new Marker("ATL CIRCLE", 39.931269, -75.051231, 0, Color.YELLOW,vic,null);
